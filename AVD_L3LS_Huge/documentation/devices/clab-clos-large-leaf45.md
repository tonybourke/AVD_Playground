...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_clab-clos-large-leaf46_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet2 | MLAG_clab-clos-large-leaf46_Ethernet2 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet7 | - | *- | *- | *- | *- | 7 |
| Ethernet8 | - | *- | *- | *- | *- | 8 |
| Ethernet9 | - | *- | *- | *- | *- | 9 |
| Ethernet10 | - | *- | *- | *- | *- | 10 |
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet3 | P2P_clab-clos-large-spine1_Ethernet46 | - | - | default | 1550 | False | - | - | - | - |
| Ethernet4 | P2P_clab-clos-large-spine2_Ethernet46 | - | - | default | 1550 | False | - | - | - | - |
| Ethernet5 | P2P_clab-clos-large-spine3_Ethernet46 | - | - | default | 1550 | False | - | - | - | - |
...
!
interface Ethernet1
   description MLAG_clab-clos-large-leaf46_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_clab-clos-large-leaf46_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_clab-clos-large-spine1_Ethernet46
   no shutdown
   mtu 1550
   no switchport
   ipv6 enable
...
!
interface Ethernet4
   description P2P_clab-clos-large-spine2_Ethernet46
   no shutdown
   mtu 1550
   no switchport
   ipv6 enable
...
!
interface Ethernet5
   description P2P_clab-clos-large-spine3_Ethernet46
   no shutdown
   mtu 1550
   no switchport
   ipv6 enable
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_clab-clos-large-leaf46_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
| Port-Channel7 | - | - | - | - | - | - | - | 7 | - |
| Port-Channel8 | - | - | - | - | - | - | - | 8 | - |
| Port-Channel9 | - | - | - | - | - | - | - | 9 | - |
| Port-Channel10 | - | - | - | - | - | - | - | 10 | - |
...
interface Port-Channel1
   description MLAG_clab-clos-large-leaf46_Port-Channel1
   no shutdown
...
| Vlan4093 | default | MLAG-IPv4-UNDERLAY-PEER | 65144 | - |
...
router bgp 65144
   ...
   neighbor interface Vlan4093 peer-group MLAG-IPv4-UNDERLAY-PEER remote-as 65144
   !
   ...
   vrf VRF_A
      ...
      neighbor 10.255.251.89 description clab-clos-large-leaf46_Vlan3009
      redistribute connected route-map RM-CONN-2-BGP-VRFS
      !
      address-family ipv4
         no neighbor 10.255.251.89 next-hop address-family ipv6
```
