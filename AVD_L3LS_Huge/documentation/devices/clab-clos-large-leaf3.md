...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_clab-clos-large-leaf4_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_clab-clos-large-leaf4_Ethernet2 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_CLAB-CLOS-LARGE-SPINE1_Ethernet4 | routed | - | 192.168.108.13/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_LINK_TO_CLAB-CLOS-LARGE-SPINE2_Ethernet4 | routed | - | 192.168.108.15/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_LINK_TO_CLAB-CLOS-LARGE-SPINE3_Ethernet4 | routed | - | 192.168.108.17/31 | default | 1550 | False | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_clab-clos-large-leaf4_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_clab-clos-large-leaf4_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_LINK_TO_CLAB-CLOS-LARGE-SPINE1_Ethernet4
   no shutdown
   mtu 1550
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_CLAB-CLOS-LARGE-SPINE2_Ethernet4
   no shutdown
   mtu 1550
   no switchport
...
!
interface Ethernet5
   description P2P_LINK_TO_CLAB-CLOS-LARGE-SPINE3_Ethernet4
   no shutdown
   mtu 1550
   no switchport
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_clab-clos-large-leaf4_Po1 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_clab-clos-large-leaf4_Po1
   no shutdown
   switchport
...
!
interface Vxlan1
   description clab-clos-large-leaf3_VTEP
...
| Net-ID | 49.0001.1921.6810.1003.00 |
| Type | level-2 |
...
| VRF_A | 192.168.101.3:10 | 10:10 | - | - | learned | 10,20,30,40,50,100,200,300,400 |
...
router bgp 65102
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description clab-clos-large-leaf4
