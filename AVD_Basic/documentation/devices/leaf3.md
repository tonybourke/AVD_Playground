...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet10 | SERVER_host2_e1 | access | 10 | - | - | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet5 | - | 192.168.108.9/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet5 | - | 192.168.108.11/31 | default | 1550 | False | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VRF_A | 192.168.101.3:10 | 10:10 | - | - | learned<br>igmp | 10,20,30,40,50,100,200,300,400 |
...
router bgp 65102
   ...
   neighbor 192.168.108.8 description spine1_Ethernet5
   neighbor 192.168.108.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.10 remote-as 65001
   neighbor 192.168.108.10 description spine2_Ethernet5
...
| 30 | True | 192.168.101.3 | - | - | - | - | - | - | - |
| 40 | True | 192.168.101.3 | - | - | - | - | - | - | - |
| 50 | True | 192.168.101.3 | - | - | - | - | - | - | - |
| 100 | True | 192.168.101.3 | - | - | - | - | - | - | - |
| 200 | True | 192.168.101.3 | - | - | - | - | - | - | - |
| 300 | True | 192.168.101.3 | - | - | - | - | - | - | - |
| 400 | True | 192.168.101.3 | - | - | - | - | - | - | - |
...
ip igmp snooping vlan 30 querier address 192.168.101.3
ip igmp snooping vlan 40 querier
ip igmp snooping vlan 40 querier address 192.168.101.3
ip igmp snooping vlan 50 querier
ip igmp snooping vlan 50 querier address 192.168.101.3
ip igmp snooping vlan 100 querier
ip igmp snooping vlan 100 querier address 192.168.101.3
ip igmp snooping vlan 200 querier
ip igmp snooping vlan 200 querier address 192.168.101.3
ip igmp snooping vlan 300 querier
ip igmp snooping vlan 300 querier address 192.168.101.3
ip igmp snooping vlan 400 querier
ip igmp snooping vlan 400 querier address 192.168.101.3
```
